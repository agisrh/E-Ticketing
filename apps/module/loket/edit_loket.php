<?php
$row = $query->get_loket($_GET['id']);
?>
<div class="col-md-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2><i class="fa fa-plus-square"></i> &nbsp;Edit Loket</h2>
                         ...
                         <form method="POST" action="" class="form-horizontal form-label-left col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" name="nama" value="<?php echo "$row[nama_loket]"; ?>" required class="form-control" placeholder="Nama Loket">
                                                <input type="hidden" value="<?php echo "$row[id_loket]"; ?>" name="id">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                               <textarea type="text" name="posisi" required class="form-control"><?php echo "$row[posisi]"; ?></textarea>
                                            </div>
                                        </div>
...
if(isset($_POST['save'])){
    ...
    // </script>";
    // }else{
        $query->edit_loket($id,$a,$b);
        $query->log_aktifitas($_SESSION[id_user],'Mengubah loket tiket',date('Y-m-d'),date('H:i:s'));
